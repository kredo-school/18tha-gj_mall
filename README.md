...
##### 1. Clone repository
```
$ git clone git@github.com:kredo-school/18tha-gj_mall.git
```
...
##### Name: localhost/18tha-gj_mall
##### HOST: localhost
##### USERNAME: root
##### PASSWORD:     
##### DATABASE: 18tha-gj_mall
##### PORT: 3306
