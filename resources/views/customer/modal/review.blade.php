        ...
        <div class="modal-content">
            ...
            <div class="modal-body">   
                <div class="row mb-4">
                    ...
                    <div class="col-7">
                        <strong class="d-block mb-3 modal_strong">Shop Name: <span class="fw-normal">Product Name</span></strong>
                        <strong class="d-block mb-3 modal_strong">Category: <span class="fw-normal">Product Category</span></strong>
                        <strong class="d-block modal_strong">Price: <span class="fw-normal">$150</span></strong>
                    </div>
                </div>
