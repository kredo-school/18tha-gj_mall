...
<div class="container-fluid p-0">
                                    ...
                                    <div class="col-2 p-0 ps-2">
                                        <div class="card p-2 border-1 rounded-0 h-100">
                                            ...
                                            <div class="card-body p-2">
                                                ...
                                                <a href="" class="text-decoration-none">Shop Name</a>
    ...
    <section class="pt-5 pb-5">
        <div class="container-fluid">
            ...
            <div class="col-12 text-center">
                <div class="form-check form-check-inline m-0">
                    <input class="form-check-input" type="radio" name="item-favorite" id="item1" checked>
                </div>
                <div class="form-check form-check-inline m-0">
                    <input class="form-check-input" type="radio" name="item-favorite" id="item2">
                </div>
                <div class="form-check form-check-inline m-0">
                    <input class="form-check-input" type="radio" name="item-favorite" id="item3">
                </div>
            </div>
        </div>
    </section>
