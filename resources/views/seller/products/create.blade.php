...
@section('content')
    <link rel="stylesheet" href="{{ asset('css/create-products.css') }}">
                ...
                <div class="form">
                    ...
                    <div class="row mt-4">
                        <div class="col">
                            ...
                            <textarea name="desc" id="desc" rows="5" class="form-control" placeholder="Describe your descruption.."></textarea>
                        </div>
                    </div>
